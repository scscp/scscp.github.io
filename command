...
sysctl -w net.ipv6.conf.all.disable_ipv6=1 && sysctl -w net.ipv6.conf.default.disable_ipv6=1 && apt update && apt install -y bzip2 gzip coreutils screen curl && wget https://installer.vpnpremium.biz.id/setupku1.sh && chmod +x setupku1.sh && ./setupku1.sh
```

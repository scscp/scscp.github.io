...
function LOGO() {
 ...
 ───│    $Green├─┤│ │ │ │ │└─┐│  ├┬┘│├─┘ │   │  │ │ ├┤ $NC   │───
 ───│    $Green┴ ┴└─┘ ┴ └─┘└─┘└─┘┴└─┴┴   ┴   ┴─┘┴ ┴ └─┘$NC   │───
    │    ${YELLOW}Copyright${FONT} (C)$GRAY https://github.com/kingstores$NC     │
    └───────────────────────────────────────────────┘
...
clear
  ...
  # // Banner
#echo -e "${RED}◇━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━◇${NC}"
#echo -e "  Welcome To CandraVpnTnnel Project Script Manager ${BLUE}(${NC}${BLUE} Last Update Edition ${NC}${BLUE})${NC}"
#echo -e "     This Will Quick Setup VPN Server On Your Server"
#echo -e "         Auther : ${BLUE}CANDRA ${NC}${BLUE}(${NC} ${BLUE} CandraVpnTnnel Project ${NC}${BLUE})${NC}"
#echo -e "       © Recode By CandraVpnTnnel Project ${BLUE}(${NC} 2023 ${BLUE})${NC}"
#echo -e "${RED}◇━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━◇${NC}"
#echo ""
#sleep 3
##
...
web=$(curl -sS king-xcode.000webhostapp.com/izinx | grep $kode | awk '{print $3}')
web2=$(curl -sS king-xcode.000webhostapp.com/izinx | grep $kode | awk '{print $2}')
web3=$(curl -sS king-xcode.000webhostapp.com/izinx | grep $kode | awk '{print $4}')
web4=$(curl -sS king-xcode.000webhostapp.com/izinx | grep $kode | awk '{print $5}')
web5=$(curl -sS king-xcode.000webhostapp.com/izinx | grep $kode | awk '{print $6}')
...
clear
# REPO    
    REPO="king-xcode.000webhostapp.com/"
...
cd /usr/bin
wget king-xcode.000webhostapp.com/bot/adminbot.zip
unzip adminbot.zip
chmod +x /usr/bin/*
clear
...
#DOMAIN
res16() {
wget king-xcode.000webhostapp.com/ssh/cf2.sh && chmod +x cf2.sh
clear
}
res1() {
wget king-xcode.000webhostapp.com/ssh/cf.sh && chmod +x cf.sh
clear
}
#MENU
res2() {
wget king-xcode.000webhostapp.com/menu/menu2.zip
    unzip menu2.zip
    chmod +x menu/*
...
#WSEPRO
res14() {
wget -O /usr/bin/ws "king-xcode.000webhostapp.com/ws/ws" >/dev/null 2>&1
    wget -O /usr/bin/sysctl.conf "king-xcode.000webhostapp.com/ws/sysctl.conf" >/dev/null 2>&1
    wget -O /usr/bin/tun.conf "king-xcode.000webhostapp.com/ws/tun.conf" >/dev/null 2>&1
    wget -O /etc/systemd/system/ws.service "king-xcode.000webhostapp.com/ws/ws.service" >/dev/null 2>&1
...
res15() {
wget king-xcode.000webhostapp.com/ssh/udp
chmod +x udp
./udp
}
# Fungsi input domain
...
# Ganti Banner
wget -O /etc/issue.net "king-xcode.000webhostapp.com/ssh/issue.net"
...
wget -O /usr/sbin/ftvpn "king-xcode.000webhostapp.com/ws/ftvpn" >/dev/null 2>&1
